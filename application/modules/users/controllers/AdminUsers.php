...
class AdminUsers extends Admin {
    ...
    public function __construct()
    {
		...
		\CI::auth()->check_access_group('users', '', true);
    ...
    {   
        ...
        {   
			...
			$data['supplier_id'] = $admin->supplier_id;
        }
        ...
        else
        {
            ...
            $save['store_id'] = \CI::input()->post('store_id');
			$save['supplier_id'] = \CI::input()->post('supplier_id');
			if(\CI::input()->post('group_id') != 5) { //hardcode
				$save['supplier_id'] = 0;
			}
