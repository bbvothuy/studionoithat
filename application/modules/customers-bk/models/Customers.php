...
Class Customers extends CI_Model
{
    ...
    {
		CI::db()->select('customers_address_bank.*, country_zones.name city_name, zone.name as district_name, ward.name as ward_name');
		CI::db()->join('country_zones', 'country_zones.id=customers_address_bank.city', 'left');
		CI::db()->join('zone', 'zone.zone_id=customers_address_bank.zone_id', 'left');
		CI::db()->join('ward', 'ward.ward_id=customers_address_bank.ward_id', 'left');
