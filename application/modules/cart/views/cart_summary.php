<div class="cartSummary">
	...
	//echo '<pre>'; print_r($charges['products']);exit;
        ...
        <div class="cartItem" id="cartItem-<?php echo $product->id;?>">
            <div class="col-nest">
                <div class="col" data-cols="1">
                    <div class="cartItemName"><a href="<?php echo site_url($product->slug.'.html');?>"><?php echo $product->name; ?></a></div>
                </div>
            </div>
    ...
    $( ".btn-booking-order" ).click(function(){
		...
		if(firstname == '' ||  email == '' || phone == '' || address1 == '' ||
            ...
            if(zone_id == 0 || zone_id == null){
                $("#zone_id").addClass('info-required');
            }
        ...
        if(city_zone_id == 0 || ward_id == 0){
            if(city_zone_id == 0){
                bootbox.alert('Quý khách vui lòng nhập Quận / Huyện');
                return false;
            }else{
                bootbox.alert('Quý khách vui lòng nhập Phường / Xã');
                return false;
            }
        }
