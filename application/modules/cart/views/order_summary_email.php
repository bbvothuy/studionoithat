...
<div style="font-family:Open-sans, Arial, Verdana, sans-serif; color:#555454; text-transform:uppercase; font-size:17px;">
    <?php echo lang('order_number');?>: <?php echo $order->invoice_number; ?>
</div>
<?php if($order->notes_customer != ''){?>
    <div style="font-family:Open-sans, Arial, Verdana, sans-serif; color:#555454;font-size:15px;">
        Note: <?php echo $order->notes_customer; ?>
    </div>
<?php }?>
        ...
        <?php foreach($charges['products'] as $product):?>
            <tr>
                <td <?php echo $productCell;?>>
                    <a href="<?php echo site_url(PRODUCT.'/'.$product->slug);?>"><strong><?php echo $product->name; ?></strong></a> <br>
