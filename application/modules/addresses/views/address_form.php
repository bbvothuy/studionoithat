    ...
    <?php echo form_open('addresses/form/'.$id, ['id'=>'addressForm']);?>
        ...
        <div class="col-nest">
            ...
            <div class="col" data-cols="1/3" data-medium-cols="1/3" data-small-cols="1/3">
                <label class="required">TP/Tỉnh <sup>*</sup></label>
                <?php $zones_menu_2 =  array('0' => '-- Thành Phố/Tỉnh --') + @$zones_menu_2;?>
			...
			<div class="col" data-cols="1/3" data-medium-cols="1/3" data-small-cols="1/3">
				...
				<?php
                    if(isset($city_zone) && !empty($city_zone)){
                        $city_zone =  array('0' => '-- Quận/Huyện --') + @$city_zone;
                    }
                ?>
    ...
    $(function(){
		...
		$('#zone_id').change(function(){
            ...
            $('#city_zone_id').load('<?php echo site_url('addresses/get-zone-options');?>/'+zone_id+'/zone', function(){
				var city_zone_id = $('#city_zone_id').val();
				if(city_zone_id == 0 || city_zone_id == null){
					addShiping();
					return;
				}
