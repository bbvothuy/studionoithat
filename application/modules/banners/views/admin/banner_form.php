...
<?php echo form_open_multipart('admin/banners/banner_form/'.$banner_collection_id.'/'.$banner_id); ?>
	...
	<div class="form-group">
        ...
        <?php echo form_input(['name'=>'content', 'value' => assign_value('content', $content), 'class'=>'form-control']); ?>
    </div>
    ...
    <div class="form-group">
        <label for="image"><?php echo lang('image');?> width: 1440px, height: 400px</label>
