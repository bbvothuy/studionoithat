    ...
    <div class="col-md-12">
        <?php echo form_open('admin/orders', 'class="form-inline" style="float:right"');?>
			<div class="form-group">
                ...
                <input name="search_delivery_date" value="" class="datepicker form-control" type="text" placeholder="Delivery Date"/>
            </div>
            <div class="form-group">
...
<table class="table table-striped">
    ...
    <tr>
        <td style="white-space:nowrap">
            <strong><a href="<?php echo site_url('admin/orders/order/'.$order->order_number);?>">Order ID: <?php echo $order->id; ?></a></strong>
