<style>
    .priority{width: 50px; display: inline}
</style>
...
<div class="row">
    ...
    <div class="col-md-4">
		...
		<div class="form-group">
            ...
            <?php echo form_input(['name'=>'priority', 'value'=>assign_value('priority', $priority), 'class'=>'form-control priority']); ?> Priority
        </div>
        ...
        <div class="form-group"> 
            ...
            <span class="help-block"><?php echo lang('meta_data_keyword');?></span>
        </div>
