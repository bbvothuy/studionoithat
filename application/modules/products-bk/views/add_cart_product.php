...
<div class="row">
	...
	<div class="layer_cart_product">
		...
		<div class="product-image-container layer_cart_img">
			<img class="layer_cart_img img-responsive" src="<?php echo get_image_primary_2($images);?>" alt="" title="<?php echo $name;?>">
		</div>
		<div class="layer_cart_product_info">
			...
			<?php $_price = get_price_sale($price_1, $saleprice_1, $sale_start_date, $sale_end_date);?>
			<div>
	...
	<div class="layer_cart_cart">
		<span class="title-modal1">
			<span>
				Hiện có <span id="totalItemsAddCart"><?php if (CI::Login()->isLoggedIn(false, false)){echo GC::totalItems();}else {echo 0};?></span> sản phẩm trong giỏ hàng.
			</span>
		</span>
		<!--
		...
		<div class="layer_cart_row">
			...
			<span class="pink"><?php echo format_currency(GC::getGrandTotal()+$_price['price']);?></span>
		</div>
