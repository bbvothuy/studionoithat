		...
		<div class="des-product-wp">
			<?php echo form_open('cart/add-to-cart', 'id="add-to-cart"');?>
				...
				<div class="product-price-block">
					<?php $_price = get_price_sale($price, $saleprice, $sale_start_date, $sale_end_date);?>
					<?php if($_price['sale']){?>
					...
					<label>* Giá trên chưa bao gồm VAT + phí vận chuyển lắp đặt</label>
				  </div>
				</div>
				<hr>
				...
				<div class="form-inline button-product-detail">
				  <div class="form-group">
					...
					<input style="width:50px;" type="text" class="form-control width-50" name="quantity" value="1">
				  </div>
