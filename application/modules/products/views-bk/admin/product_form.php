    ...
    <div class="row">
        <div class="col-md-9">
            <div class="tabbable">
                <ul class="nav nav-tabs">
					...
					<li><a href="#product_bonus" data-toggle="tab" id="tab_bonus">Bonus</a></li>
					<li><a href="#product_combo" data-toggle="tab" id="tab_combo">Product Combo</a></li>
                </ul>
            </div>
            <div class="tab-content">
				...
				<div class="tab-pane" id="product_bonus">
				...
				<div class="tab-pane" id="product_combo">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            {
                                $.post("<?php echo site_url('admin/products/product_autocomplete/');?>", { name: $('#product_combo_search').val(), limit:10},
                                    function(data) {
                                        ...
                                        $.each(data, function(index, value){
                                            ...
                                            {
                                                $('#product_combo_list').append('<option id="product_combo_item_'+index+'" value="'+index+'">'+value+'</option>');
                                            }
                                        });
        ...
        <div class="col-md-3">
			<div class="form-group">
                ...
                <?php echo form_dropdown('product_type', [0 => 'Normal', 1 => 'To have bonus', 2 => 'Combo'], assign_value('product_type',@$product_type), 'class="form-control" id="product_type"');?>
            </div>
			...
			<div class="form-group">
                ...
                <?php echo form_checkbox('top_home', 1, $top_home); ?> <?php echo lang('enabled');?>
            </div>
			...
			<div class="form-group">
				<label>Size</label><br>
                <?php echo form_dropdown('size', [0 => 'Small', 1 => 'Medium', 2 => 'Large'], assign_value('size',$size), 'class="form-control"');?>
            </div>
...
<script type="text/template" id="comboItemsTemplate">
    <tr id="combo_product_{{id}}">
        <td>
            <input type="hidden" name="combo_products[]" value="{{id}}"/>
            {{name}}
        </td>
        <td class="text-right">
...
$(document).ready(function() {
	...
	$.each(comboItems, function(key,val) {
        add_combo_product(val.id, val.name);
    });
...
function add_combo_product(id, name)
{
    var view = null;
    if(id != undefined && name != undefined)
    {
