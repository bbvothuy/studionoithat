    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <?php if($supplier_id > 0){?>
                <div class="form-group div-size">
                    <label for="confirm">Confirmed</label>
                    <?php echo form_dropdown('confirm', [0 => 'No', 1 => 'Yes'], assign_value('confirm',$confirm), 'class="form-control size"');?>
                </div>
                <div class="form-group div-size">
                    <label for="weight">Supplier</label>
                    <?php
                    $suppliers_option = array();
                    foreach($suppliers as $supplier){
                        $suppliers_option[$supplier->id] = $supplier->name;
                    }
                    echo form_dropdown('', $suppliers_option, assign_value('supplier_id',$supplier_id), 'class="form-control size" disabled="disabled"');
                    ?>
                </div>
            <?php }?>

			<div class="form-group div-product_type">
			...
			<div class="form-group div-label-new">
			...
			<div class="form-group div-weight">
            ...
            <div class="form-group div-manuafacture">
