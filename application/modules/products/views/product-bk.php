                        ...
                        <div class="des-product-wp">
                            ...
                            <div class="form-inline button-product-detail">
                              <div class="form-group">
                                ...
                                <input style="width: 40px;" type="text" class="form-control" value="1">
                              </div>
                              <div class="form-group">
		...
		<?php if(!empty($product->related_products)):?>
			...
			<div class="block-product-scroll block-product-scroll-no margin-tb">
                <div class="owl-carousel3">
					<?php foreach($relatedProducts as $tmp_product){$_price = get_price_sale($tmp_product->price, $tmp_product->saleprice);?>
					<div class="item">
                        <div class="product-block-wp">
                            <div class="view view-fifth">
                                ...
                                <a title="<?php echo $tmp_product->name;?>" href="<?php echo url_product($tmp_product->slug);?>">
                            ...
                            <div class="description top-pro-cen">
                                <div class="name-product">
                                    <h3><a title="<?php echo $tmp_product->name;?>" href="<?php echo url_product($tmp_product->slug);?>"><?php echo $tmp_product->name;?></a></h3>
                                </div>
                                <?php if($_price['sale']){?>
								<p class="product-price"><?php echo format_currency($_price['price']);?></p>
								<p class="product-price old"><?php echo format_currency($_price['price_old']);?></p>
