...
$routes[] = ['GET|POST', '/admin/customers/contact_list', 'GoCart\Controller\AdminCustomers#contact_list'];
$routes[] = ['GET|POST', '/admin/customers/suppliers', 'GoCart\Controller\AdminCustomers#suppliers'];
