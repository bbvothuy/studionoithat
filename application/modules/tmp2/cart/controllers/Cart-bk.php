...
class Cart extends Front {
	...
	public function getGeo($country_zone_id, $zone_id, $ward_id) {
		$query = \CI::db()->query("SELECT g.* FROM geo_zone g, zone_to_geo_zone zg WHERE g.geo_zone_id = zg.geo_zone_id and ward_id = '" . (int)$ward_id . "' and zone_id = '" . (int)$zone_id . "' and country_zone_id = '". (int)$country_zone_id . "'");		
