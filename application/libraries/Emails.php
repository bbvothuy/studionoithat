...
class Emails {
    ...
    */
    static function Order($order)
    {
        ...
        //$logo = '<div><a href="'.site_url().'"><img src="'.base_url().'/themes/default/assets/images/logo.png" alt=""></a></div>';
        //$fields = ['customer_name'=>$customerName, 'site_name'=>config_item('company_name'), 'order_summary'=>$view->get('order_summary_email', ['order'=>$order]), 'site_name' => $site_name, 'logo' => $logo];
